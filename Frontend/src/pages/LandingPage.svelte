...
<body>
    ...
    <div class="split left" style="width:30%">
        ...
        <div id="left-part">
            <p class="accroche">
                Participez à des expériences en <em>linguistique </em> et faites
                avancer la <em>recherche</em>
            </p>
            ...
            <p class="quote">
                "LE meilleur (seul) site pour participer à des expériences en
                linguistique !" Béatrice.
            </p>
        </div>
    </div>
